...
UIScene_MainMenu::UIScene_MainMenu(int iPad, void *initData, UILayer *parentLayer) : UIScene(iPad, parentLayer)
{
	...
	m_buttons[(int)eControl_Leaderboards].init(L"Mods", eControl_Mods);
	...
	m_buttons[(int)eControl_Mods].init(L"Mods", eControl_Mods);
...
void UIScene_MainMenu::RunMods(int iPad)
{
	ui.NavigateToScene(iPad, eUIScene_ModsMenu);
}
